...
- **Learner field whitelist.** Stem, options / option-table, figures (TikZ / original crop), equations, statements, tables, and (student-take only) the learn-by-solve *follow-up question text* after a wrong letter. **Banned on learner copy:** mx ledger, mx_type labels, examiner comments, crop paths, printed SMILES strings, mix-up ledgers, answer keys, modify seeds. SMILES may be packed for the drawer; they are never printed as text.
